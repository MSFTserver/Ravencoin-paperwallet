"ua": {
  "choosecurrency": "Оберіть валюту",
    ...
    "donate": "Пожертвувати",
    "generatelabelravencoinaddress": "Створюється нова адреса...",
    ...
    "singlelabelravencoinaddress": "Публічна адреса",
    ...
    "securitystep0": "Насамперед <strong>завантажте</strong> цей сайт з <a href=\"https://github.com/MSFTserver/Raven-paperwallet/releases\">Github</a>, розархівуйте його і безпосередньо з вашого комп'ютера відкрийте файл index.html. Це достатньо просто сховати деякий шкідливий код у 6000+ рядків javascript, щоб поцупити ваш приватний ключ, але ви ж не хочете довідатися, що ваші кошти вкрадено. Контроль версії кода дозволяє набагато простіше перевіряти діючу програму. Для забезпечення додаткової безпеки, <strong>відключіть доступ до Інтернету</strong> під час створення вашого гаманця.",
    ...
    "brainlabelravencoinaddress": "Публічна адреса:",
    ...
    "detaillabelravencoinaddress": "Публічна адреса",
    "detaillabelravencoinaddresscomp": "Публічна адреса (стиснута)",
    ...
    "footersupport": "Підтримати Ravencoin-paperwallet",
    ...
    "defaultTitle": "Ravencoin-paperwallet - універсальний генератор паперових гаманців для біткойнів та інших криптовалют",
